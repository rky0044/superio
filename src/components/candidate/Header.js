                ...
                <div className="mobile-header">
                    ...
                    <div className="nav-outer clearfix">
                        ...
                        <div className="outer-box">
                            ...
                            <button id="toggle-user-sidebar"><img src="images/resource/company-6.png" alt="avatar" className="thumb" /></button>
                            <a href="#nav-mobile" className="mobile-nav-toggler navbar-trigger"><span className="flaticon-menu-1"></span></a>
                        </div>
                    </div>
